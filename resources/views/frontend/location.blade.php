...
<x-user-view-layout>
    <div class="text-center container-fluid">
        <div class="row">
            <div class="container-fluid px-0"> <!-- container-fluid for full-width -->
                <div class="position-relative w-100">
                    <img src="img/location/header/heade1.png" class="img-fluid w-100" alt="Menu Image 1" style="object-fit: cover; max-height: 400px;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-start bg-dark bg-opacity-50 text-white ps-4">
                        <h1 style="font-size: 2vw; font-weight: 400; " class="mx-lg-5">JOEY’S RAMEN HOUSE BRANCHES</h1>
                        <h2 style="font-size: 6vw; font-weight: 700;" class="mx-lg-5">LOCATIONS</h2>
                    </div>
                </div>
            </div>
