...
<h5 class="text-white bg-danger rounded-1 py-2 py-lg px-3 fs-1 text-center"><strong>Ozamiz Branch</strong></h5>
<div class="container-fluid pb-4 rounded-1 px-0" style="background-color:white;">
    <h5 class="text-white bg-success py-3 px-3 fs-1 text-center mt-0 mt-lg-0"><strong>Desserts</strong></h5>
