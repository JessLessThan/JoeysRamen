...
<div class="container-fluid pb-4 rounded-1 px-0" style="background-color:white;">
    <h5 class="text-white bg-success py-3 px-3 fs-1 text-center mt-0 mt-lg-0"><strong>Sashimi</strong></h5>
    <div class="row d-flex justify-content-start align-items-lg-start row-cols-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 pt-2 g-3 mx-0">
        @foreach ($sashimiProducts as $product)
            <div class="col">
                <div class="card text-center mt-1 d-flex flex-column">
                    <img src="{{ asset('uploads/' . $product->photo) }}" 
                         class="card-img-top img-fluid" 
                         alt="{{ $product->name }}" 
                         style="object-fit: cover; max-height: 100%; width: 100%; height: 230px;">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div>
                            <button class="btn btn-success text-white w-100"><strong>Order</strong></button>
                        </div>
                    </div>                    
                </div>
            </div> 
