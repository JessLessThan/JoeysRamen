...
<script>
  ...
  function showEditProfile() {
    ...
    document.getElementById('backToProfile').onclick = function () {
      ...
      reinitializeEditProfileButton(); // Reinitialize button to ensure it works again
    };
  }

  // Function to reinitialize the edit profile button
  function reinitializeEditProfileButton() {
    document.getElementById('editProfileBtn').addEventListener('click', showEditProfile);
  }

  // Initialize edit profile button
  reinitializeEditProfileButton();
</script>
